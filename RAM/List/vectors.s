...
//                    接受 像素处理  死机\src\Sources\Cpu\vectors.c           /
//    Command line =  "C:\Users\Administrator\Desktop\4.25屏幕 下位机 发送    /
//                    接受 像素处理  死机\src\Sources\Cpu\vectors.c" -lCN     /
...
// C:\Users\Administrator\Desktop\4.25屏幕 下位机 发送 接受 像素处理  死机\src\Sources\Cpu\vectors.c
//    1 //-------------------------------------------------------------------------*
//    2 // 文件名: vectors.h                                                       *
//    3 // 说  明: 中断向量表                                                      *
//    4 //-------------------------------------------------------------------------*
...
__vector_table:
        ...
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 PIT0_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
        DC32 default_isr, default_isr, default_isr, default_isr, default_isr
...
//  277 //默认中断服务例程函数
        ...
        THUMB
//  278 void default_isr(void)
//  279 {
//  280    #define VECTORNUM                     (*(volatile uint8_t*)(0xE000ED04))
//  281    return;
default_isr:
        BX       LR               ;; return
//  282 }
