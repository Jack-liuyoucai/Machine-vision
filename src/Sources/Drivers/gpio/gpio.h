...
void    gpio_init  (PORTx, uint8 n, GPIO_CFG, uint8 data);  //初始化gpio

void    gpio_set   (PORTx,  uint8 n,     uint8 data);                                                 //设置引脚状态
void    gpio_turn  (PORTx,  uint8 n);                                                              //翻转引脚状态
uint8      gpio_get   (PORTx,  uint8 n);                                                              //读取引脚状态
