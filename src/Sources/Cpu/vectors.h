...
#define __VECTORS_H     1
    ...
    #define VECTOR_061        default_isr // uart0_isr  0x0000_00F4 61    45     UART0            Single interrupt vector for UART status sources
    ...
    #define VECTOR_104        PTB_isr // default_isr    0x0000_01A0 104   88     Port control module Pin Detect (Port B)
